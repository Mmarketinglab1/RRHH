...
class Response(Base):
    ...
    selected_option: Mapped[str | None] = mapped_column(String(200), default=None, nullable=True)
    selected_options: Mapped[list | None] = mapped_column(JSON, default=None, nullable=True)
